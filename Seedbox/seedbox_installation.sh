...
function qBittorrent {
    warn_2
    source <(wget -qO- https://raw.githubusercontent.com/codecopy/Seedbox/main/TorrentClients/qBittorrent/qBittorrent_install.sh)
...
function Deluge {
    warn_2
    source <(wget -qO- https://raw.githubusercontent.com/codecopy/Seedbox/main/TorrentClients/Deluge/Deluge_install.sh)
    Deluge_download
    Deluge_install
    Deluge_config
